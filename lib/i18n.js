...
const TRANSLATIONS = {
  ...
  legal: {
    placeholderBadge: { de: "⚠️ Platzhalter -- noch nicht veröffentlichungsreif", en: "⚠️ Placeholder -- not yet ready for publication" },
    placeholderBody: {
      de: "Diese Seite ist ein Platzhalter und noch NICHT veröffentlichungsreif -- der endgültige, rechtlich geprüfte Text folgt vor dem öffentlichen Launch.",
      en: "This page is a placeholder and is NOT yet ready for publication -- the final, legally reviewed text will follow before public launch.",
    },
  ...
  learn: {
    h1: { de: "Lernen", en: "Learn" },
    subtitle: {
      de: "Sechs Lernpfade rund um Geld, Investieren und Märkte -- die Inhalte entstehen gerade.",
      en: "Six learning paths on money, investing, and markets -- content is currently being built.",
    },
    intro: {
      de: "Dieser Bereich wird Finlyras Bildungsangebot: kurze, verständliche Lernpfade statt trockener Fachtexte. Aktuell siehst du die geplante Struktur -- noch keine fertigen Lektionen.",
      en: "This section will become Finlyra's learning offering: short, understandable learning paths instead of dry technical text. Right now you see the planned structure -- no finished lessons yet.",
    },
    statusInPreparation: { de: "In Vorbereitung", en: "In preparation" },
    audienceLabel: { de: "Zielgruppe:", en: "Audience:" },
    goalLabel: { de: "Lernziel:", en: "Goal:" },
    modulesLabel: { de: "Geplante Module:", en: "Planned modules:" },
    pathMoneyTitle: { de: "Geld verstehen", en: "Understanding money" },
    pathMoneyAudience: { de: "Einsteiger ohne Vorkenntnisse", en: "Beginners with no prior knowledge" },
    pathMoneyGoal: { de: "Grundbegriffe rund um Geld, Konten und Budgetierung sicher einordnen können", en: "Confidently understand basic concepts around money, accounts, and budgeting" },
    pathMoneyModule1: { de: "Wie Geld funktioniert", en: "How money works" },
    pathMoneyModule2: { de: "Konten, Karten, Überweisungen", en: "Accounts, cards, transfers" },
    pathMoneyModule3: { de: "Ein einfaches Budget aufstellen", en: "Setting up a simple budget" },
    pathSavingTitle: { de: "Sparen und Konsumfallen", en: "Saving and spending traps" },
    pathSavingAudience: { de: "Alle, die bewusster mit Geld umgehen wollen", en: "Anyone who wants to handle money more consciously" },
    pathSavingGoal: { de: "Typische Konsumfallen erkennen und eine Spargewohnheit aufbauen", en: "Recognize typical spending traps and build a savings habit" },
    pathSavingModule1: { de: "Warum Sparen schwerfällt", en: "Why saving is hard" },
    pathSavingModule2: { de: "Häufige Konsumfallen", en: "Common spending traps" },
    pathSavingModule3: { de: "Ein Spar-System, das hält", en: "A savings system that sticks" },
    pathInvestingTitle: { de: "Investieren beginnen", en: "Getting started with investing" },
    pathInvestingAudience: { de: "Einsteiger mit erster Rücklage", en: "Beginners with some initial savings" },
    pathInvestingGoal: { de: "Die ersten Schritte beim Investieren verstehen, inklusive Risiko", en: "Understand the first steps of investing, including risk" },
    pathInvestingModule1: { de: "Rendite, Risiko, Zeit", en: "Return, risk, time" },
    pathInvestingModule2: { de: "Anlageklassen im Überblick", en: "Asset classes at a glance" },
    pathInvestingModule3: { de: "Den ersten Depot-Schritt planen", en: "Planning your first brokerage step" },
    pathEtfTitle: { de: "ETFs verstehen", en: "Understanding ETFs" },
    pathEtfAudience: { de: "Einsteiger, die von ETFs gehört haben, aber unsicher sind", en: "Beginners who've heard of ETFs but feel unsure" },
    pathEtfGoal: { de: "Verstehen, was ein ETF ist und worauf bei der Auswahl zu achten ist", en: "Understand what an ETF is and what to look for when choosing one" },
    pathEtfModule1: { de: "Was ist ein ETF", en: "What is an ETF" },
    pathEtfModule2: { de: "Kosten und Diversifikation", en: "Costs and diversification" },
    pathEtfModule3: { de: "Einen ETF-Sparplan verstehen", en: "Understanding an ETF savings plan" },
    pathCryptoTitle: { de: "Märkte und Krypto verstehen", en: "Understanding markets and crypto" },
    pathCryptoAudience: { de: "Nutzer, die Finlyras Dashboard bereits kennen", en: "Users already familiar with Finlyra's dashboard" },
    pathCryptoGoal: { de: "Kryptomärkte im Kontext von Makro-Umfeld und Marktzyklen einordnen können", en: "Be able to place crypto markets in the context of the macro environment and market cycles" },
    pathCryptoModule1: { de: "Wie Kryptomärkte ticken", en: "How crypto markets tick" },
    pathCryptoModule2: { de: "Makro-Umfeld und Zyklen", en: "Macro environment and cycles" },
    pathCryptoModule3: { de: "Das Dashboard richtig lesen", en: "Reading the dashboard correctly" },
    pathTradingTitle: { de: "Trading und Risikomanagement", en: "Trading and risk management" },
    pathTradingAudience: { de: "Nutzer mit ersten Trades oder klarem Interesse am Trading", en: "Users with some trading experience or clear interest in trading" },
    pathTradingGoal: { de: "Risiko strukturiert begrenzen, statt aus dem Bauch heraus zu handeln", en: "Limit risk in a structured way instead of trading on gut feeling" },
    pathTradingModule1: { de: "Positionsgröße und Risiko pro Trade", en: "Position size and risk per trade" },
    pathTradingModule2: { de: "Stop-Loss und Hebel verstehen", en: "Understanding stop-loss and leverage" },
    pathTradingModule3: { de: "Eigene Trades strukturiert festhalten", en: "Keeping structured records of your own trades" },
  },
  glossar: {
  ...
  onboarding: {
    ...
    step0Skip: { de: "Ohne Auswahl weiter →", en: "Continue without choosing →" },
    ...
    skip: { de: "Tour überspringen", en: "Skip tour" },
    back: { de: "Zurück", en: "Back" },
  ...
  dashboard: {
    ...
    subtitle: { de: "Märkte verstehen -- mit Daten, Kontext und transparenten Analysen.", en: "Understanding markets -- with data, context, and transparent analysis." },
    refresh: { de: "Aktualisieren", en: "Refresh" },
    refreshing: { de: "Aktualisiere…", en: "Refreshing…" },
    refreshSuccess: { de: "Aktualisiert ✓", en: "Updated ✓" },
    refreshPartial: { de: "Aktualisiert -- einzelne Quellen nicht verfügbar", en: "Updated -- some sources unavailable" },
    dataStatusTitle: { de: "Datenstand: ", en: "Data status: " },
    sourceCrypto: { de: "Kurse", en: "Prices" },
    sourceMacro: { de: "Makrodaten", en: "Macro data" },
    sourceSentiment: { de: "Sentiment", en: "Sentiment" },
    sourceWhale: { de: "Whale-Daten", en: "Whale data" },
    sourceLiquidity: { de: "Liquidität", en: "Liquidity" },
    sourceNews: { de: "News", en: "News" },
    sourceUnavailable: { de: "nicht verfügbar", en: "unavailable" },
    justNow: { de: "gerade eben", en: "just now" },
    minutesAgo: { de: "vor {{n}} Min.", en: "{{n}} min ago" },
    hoursAgo: { de: "vor {{n}} Std.", en: "{{n}}h ago" },
    topic_crypto: { de: "Krypto", en: "Crypto" },
    topic_etf: { de: "ETF", en: "ETF" },
    topic_central_banks: { de: "Zentralbanken", en: "Central banks" },
    topic_inflation_jobs: { de: "Inflation/Jobs", en: "Inflation/jobs" },
    topic_rates_dollar: { de: "Zinsen/Dollar", en: "Rates/dollar" },
    topic_regulation: { de: "Regulierung", en: "Regulation" },
    topic_stocks_bonds: { de: "Aktien/Anleihen", en: "Stocks/bonds" },
    topic_corporate_macro: { de: "Unternehmen/Konjunktur", en: "Corporate/macro" },
    beginnerModeTooltip: {
    ...
    tipBadge: { de: "💡 Historisch getestete Konfiguration", en: "💡 Historically tested configuration" },
...
// Positionierung: das Haupt-Badge pro Coin-Karte (combined.label aus
// combineSignal(), lib/signals.js) soll nicht wie eine Handlungsaufforderung
// wirken ("Kaufen"/"Verkaufen"/"Halten"), sondern eine Zustandsbeschreibung
// sein -- Finlyra hilft einordnen, gibt aber keine persönliche
// Anlageempfehlung. Rein darstellungsseitig, ändert nichts an combineSignal()
// selbst und NICHT dasselbe wie translateSignalLabel() (das bleibt für alle
// anderen ~15 Signal-Label-Stellen im Dashboard unverändert -- diese Funktion
// wird bewusst nur an der EINEN Haupt-Badge-Stelle in pages/index.js
// eingesetzt). combineSignal() liefert nachweislich genau diese 5 Strings,
// kein Fallback auf den Rohtext nötig.
const SIGNAL_POSITIONING_MAP = {
  Kaufen: { de: "Technisches Gesamtbild: bullish", en: "Technical picture: bullish" },
  Verkaufen: { de: "Technisches Gesamtbild: bearish", en: "Technical picture: bearish" },
  "Halten (bullish)": { de: "Technisches Gesamtbild: leicht bullish", en: "Technical picture: slightly bullish" },
  "Halten (bearish)": { de: "Technisches Gesamtbild: leicht bearish", en: "Technical picture: slightly bearish" },
  Neutral: { de: "Technisches Gesamtbild: neutral", en: "Technical picture: neutral" },
};

export function signalPositioningLabel(rawLabel, lang) {
  const entry = SIGNAL_POSITIONING_MAP[rawLabel];
