...
export function runOptimization({
  ...
  const shared = { macro, fearGreedHistory, fundingRates, stopLossPct, allowShort, leverage, costPct, useBollinger, useStochRsi, useObv };
...
export function runMultiCoinOptimization({
  ...
  const shared = { macro, fearGreedHistory, stopLossPct, allowShort, leverage, costPct, useBollinger, useStochRsi, useObv };
