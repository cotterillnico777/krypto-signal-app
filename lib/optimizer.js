...
export function runOptimization({
  ...
  const shared = { macro, fearGreedHistory, fundingRates, stopLossPct, allowShort, leverage, costPct, useBollinger, useStochRsi, useObv, useStrongCandle, useMarubozu, useSma, useMacd, useRsi, useFg, useMacro, useVolume, useNasdaq, macroWeight, signalThreshold };
...
export function runMultiCoinOptimization({
  ...
  const shared = { macro, fearGreedHistory, stopLossPct, allowShort, leverage, costPct, useBollinger, useStochRsi, useObv, useStrongCandle, useMarubozu, useSma, useMacd, useRsi, useFg, useMacro, useVolume, useNasdaq, macroWeight, signalThreshold };
