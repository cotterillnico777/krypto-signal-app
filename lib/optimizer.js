...
export function runOptimization({
  ...
  const shared = { macro, fearGreedHistory, fundingRates, stopLossPct, allowShort, leverage, costPct, useBollinger, useStochRsi, useObv, useSma, useMacd, useRsi, useFg, useMacro, useVolume, macroWeight, signalThreshold };
...
export function runMultiCoinOptimization({
  ...
  const shared = { macro, fearGreedHistory, stopLossPct, allowShort, leverage, costPct, useBollinger, useStochRsi, useObv, useSma, useMacd, useRsi, useFg, useMacro, useVolume, macroWeight, signalThreshold };
