...
// Bänder, Stochastic RSI, On-Balance-Volume) sind dagegen voll historisch
// verfügbar und werden auch vom Backtest übergeben.
...
export function computeAllSignals(coins, macro, fgValue, whaleData = {}) {
  return coins.map((c) => {
    ...
    const combined = combineSignal(smaSig, rsi, macro, fgValue, macdSig, volSig, { whaleSig, bollSig, stochRsiSig, obvSig });
