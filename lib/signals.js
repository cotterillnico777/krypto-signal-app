...
// whaleSig, bollSig, stochRsiSig, obvSig }. Alle optional und
// rückwärtskompatibel – ohne opts verhält sich die Funktion exakt wie zuvor.
// adxThreshold wirkt als Trendfilter: bei schwachem Trend (adx < adxThreshold)
// werden Crossover-Signale (Kaufen/Verkaufen) zu "Halten" abgeschwächt statt
// blind gehandelt zu werden. whaleSig kommt aus whaleSignal() (Top-Trader-
// Positionierung, siehe dort) – nur live verfügbar (Binance hält die Daten
// nur ~30 Tage), Backtest/Optimizer/Walk-Forward/Portfolio übergeben sie nie
// und bleiben dadurch unverändert. bollSig/stochRsiSig/obvSig (Bollinger
// Bänder, Stochastic RSI, On-Balance-Volume) sind voll historisch verfügbar,
// werden aber standardmäßig NICHT übergeben (weder vom Dashboard/Cron noch
// von runBacktest) – ein Walk-Forward-Vergleich (2026-08-08, alle drei
// einzeln über 3 Zeitfenster) zeigte, dass keiner davon die Out-of-Sample-
// Rendite/Sharpe verbessert. Bleiben als Parameter nutzbar für gezielte
// Experimente (siehe runBacktest useBollinger/useStochRsi/useObv).
