...
export function computeAllSignals(coins, macro, fgValue, whaleData = {}) {
  return coins.map((c) => {
    ...
    // bollSig/stochRsiSig/obvSig/candleSig fließen bewusst nicht in
    // combineSignal ein (siehe combineSignal-Kommentar) – hier trotzdem
    ...
    return { coin: c, rsi, smaSig, macdSig, volSig, whaleSig, bollSig, stochRsiSig, obvSig, candleSig, combined };
  });
}
