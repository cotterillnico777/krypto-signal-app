...
export const PARAM_TIPS = {
  ...
  dogecoin: {
    ...
    label: "1x Nur Long, kein Stop-Loss (Standard)",
    evidence:
      "1x Long+Short sah im 730-Tage-Fenster stark aus (Ø-Rendite +6,7%, Sharpe +0,78), blieb aber im 850-Tage-Fenster im Minus (-9,3%) -- kein durchgehend profitabler Tipp. Höhere Hebel und Stop-Loss-Varianten schnitten in beiden Fenstern schlechter ab als die Standardeinstellung.",
  },
};
